/***********************************************
*                                              *
*    GenesisCORE - OpenGL Framework Core       *
*    Based on NeHe's OpenGL Basecode           *
*                     2001                     *
*                                              *
***********************************************/
...
#include "GenesisCORE.h"														// Header File For The GenesisCORE Framework
...
int WINAPI WinMain (HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	window.init.title			= "GenesisV - OpenGL Framework";			// Window Title
